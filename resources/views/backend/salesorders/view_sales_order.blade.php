            ...
            <div class="container-fluid">
                <div class="row mb-12">
                    <div class="col-sm-6 text-center">
                        <h1><i class="fa-solid fa-baby- "></i> Create  Sales Orders</h1>
                    </div>
                    ...
                    <div class="card-body table-responsive p-0">
                        <div class="row">
                            ...
                            <div class="col-6" style="background-color: white">
                                <div class="mb-3 row">
                                    <div class="col-7">
                                        <label style="font-size: 30px; padding-left:6px; for="name">Customers007</label>

                                        @php
                                            $customer = DB::table('customer_models')->get();
                                        @endphp
                                ...
                                <div>
                                        ...
                                        <table class="table">
                                            ...
                                            <tbody>
                                                @foreach ($cart_product as $cart)
                                                    <tr onMouseOver="this.style.color='#000000'">
                                                        <th>{{ $cart->name }}</th>
                                                        <th>
                                    ...
                                    <div class="pl-4 pricing-footer bg-primary">
                                        ...
                                        <form method="post" action="{{ url('/create-invoice') }}">
                                            ...
                                            <div class="mt-3" >
                                                <div class="btn btn-info text-right" style="font-size: 100px">
                                                <select name="cust0003"class="form-control bg-primary">
